class Game {
    ...
    picture() {
        ...
        switch (this.player) {
            case 'Rock':
                var srcPic1 = "/Rock-Paper-Scissors/pictures/rock.png"
                break;
            case 'Paper':
                var srcPic1 = "/Rock-Paper-Scissors/pictures/paper.png"
                break;
            case 'Scissors':
                var srcPic1 = "/Rock-Paper-Scissors/pictures/scissors.png"
                break;
            default:
                break;
        }
        ...
        switch (this.choices[this.choice]) {
            case 'Rock':
                var srcPic2 = "/Rock-Paper-Scissors/pictures/rock2.png"
                break;
            case 'Paper':
                var srcPic2 = "/Rock-Paper-Scissors/pictures/paper2.png"
                break;
            case 'Scissors':
                var srcPic2 = "/Rock-Paper-Scissors/pictures/scissors2.png"
                break;
            default:
                break;
        }
